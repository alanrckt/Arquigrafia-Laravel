        ...
        <form id="upload_form_meta" name="dados" method="POST" action="/photo/7/registra" enctype="multipart/form-data">
          ...
          <div class="five columns alpha row">
            ...
            <tr>
              ...
              <td><input name="photoRegister.name" type="text" class="text" placeholder="Residência Sylvio Bresser Pereira"></td>
            </tr>
            <tr>
              <td><label>Autor da imagem:</label></td>
              <td><input name="photoRegister.imageAuthor" type="text" class="text" placeholder="João Carlos Vieira"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><textarea name="photoRegister.description" class="input_content"></textarea>
            		</td>
            </tr>
          </table>
          </div>
          ...
          <div class="five columns omega row">
              ...
              <tr>
                <td><label>Autor da imagem:</label></td>
                <td><input name="photoRegister.#" type="text" class="text" placeholder="Phasellus ligula ligula"></td>
              </tr>
              <tr>
                <td><label>Data da imagem:</label></td>
                <td><input name="photoRegister.#" type="text" class="text" id="imagedate" placeholder="01/01/01"></td>
              </tr>
              <tr>
                <td><label>Autor da obra:</label></td>
                <td><input name="photoRegister.#" type="text" class="text" id="workdate" placeholder="01/01/01"></td>
              </tr>	
              <tr>
                <td><label>Data da obra:</label></td>
                <td><input name="photoRegister.workdate" type="text" class="text" id="workdate" placeholder="01/01/01"></td>
              </tr>
            </table>
          </div>
          ...
          <div class="four columns" id="creative_commons_left_form">
            ...
            <br>
             <div class="form-row">
              <input type="radio" name="photoRegister.allowCommercialUses" value="YES" id="photoRegister.allowCommercialUses" checked="checked">
              <label for="photoRegister.allowCommercialUses">Sim</label><br class="clear">
             </div>
             <div class="form-row">
              <input type="radio" name="photoRegister.allowCommercialUses" value="NO" id="photoRegister.allowCommercialUses">
              <label for="photoRegister.allowCommercialUses">Não</label><br class="clear">
             </div>
          ...
          <div class="four columns" id="creative_commons_right_form">
            ...
            <br>
            <div class="form-row">
              <input type="radio" name="photoRegister.allowModifications" value="YES" id="photoRegister.allowModifications" checked="checked">
              <label for="question_3-5">Sim</label><br class="clear">
            </div>
           	<div class="form-row">
              <input type="radio" name="photoRegister.allowModifications" value="YES_SA" id="photoRegister.allowModifications">
              <label for="question_3-5">Sim, contanto que os outros compartilhem de forma semelhante</label><br class="clear">
             </div>
           	<div class="form-row">
              <input type="radio" name="photoRegister.allowModifications" value="NO" id="photoRegister.allowModifications">
